...
/*
The first comand line argument is the name of the file with sample tiles. I assume that there are 14 tiles. 
The second argument is the number of tiles which will be generated.
*/
